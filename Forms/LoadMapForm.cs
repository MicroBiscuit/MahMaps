...
namespace MahMaps.Forms
{
    public partial class LoadMapForm : Form
    {
        ...
        private void OKButton_Click(object sender, EventArgs e)
        {
            ...
            Game1.tileWidth = Game1.map.tileHeight;
            Game1.tileWidth = Game1.map.tileWidth;

            //Update the map size and tile dimensions
            Game1.map = new MapClasses.Map(Game1.mapWidth, Game1.mapHeight, Game1.tileWidth, Game1.tileHeight);
